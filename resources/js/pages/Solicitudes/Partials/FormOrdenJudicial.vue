...
<template>
    <div class="space-y-4">
        <Heading :level="2">Detalles de la Orden Judicial</Heading>
        <div class="space-y-2">
            <Label for="nombre_juzgado_tribunal">Nombre del Juzgado o Tribunal</Label>
            <Input
        ...
        <div class="space-y-2">
            <Label for="numero_orden_judicial">Número de Orden Judicial</Label>
            <Input
